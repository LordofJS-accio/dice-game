...
function rollDice(eventDetails){
    ...
    // getting index from values(id) of the button (btn1, btn2, btn3, btn4,btn5)
...
// making the end button disabled sp that end button canaot be clicked before the game starts
